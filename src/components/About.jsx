    ...
    <section className='px-5 pt-10 h-screen flex flex-col items-center md:justify-center'>
      <div className='flex flex-col items-center md:flex-row'>
        ...
        <div className='flex flex-col items-center max-w-[620px] mt-3 md:mx-4'>
          ...
          <p className=' cursor-default text-lg mb-10 animate-fade-in-y dark:text-white'>I'm Developer Front End Trainee, electronics technician and student of computer science degree. I desire to grow up professonally, learn, better oneself and have my first work experiences.</p>
